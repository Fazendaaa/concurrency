...
/*
*   Data  uma matrix e o id do processo, essa função irá dividir as linhas responsáveis pelo processo pelo valor de seus
*   respectivos pivots, o que irá que sua diagonal seja igual a um.
*/
static void pivoting (const int world_rank, const int world_size, int **matrix, const size_t matrix_size) {
...
*/
static void merge_matrix (const int world_rank, const int world_size, int **matrix, const size_t matrix_size) {
